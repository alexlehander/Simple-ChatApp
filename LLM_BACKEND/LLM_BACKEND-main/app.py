...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "SE TE PROHÍBE solucionar el problema o sub-problemas en los que se puede dividir el ejercicio con el que está trabajando el usuario. "
