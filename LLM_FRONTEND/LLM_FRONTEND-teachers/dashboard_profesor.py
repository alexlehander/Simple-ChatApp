...
def main(page: ft.Page):
    ...
    def show_dashboard():
        ...
        page.add(ft.Row([ft.Text("Panel Profesor", size=20, weight="bold"), 
                         ft.IconButton(ft.Icons.LOGOUT, on_click=lambda e: (page.client_storage.remove("teacher_token"), show_login()))], 
